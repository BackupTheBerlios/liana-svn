 ...
 * methods annotated by MouseClickedFor.  The responder method must not have
 * any parameters.
 * 
 * @author pchapman
 */
...
public @interface MouseClickedFor
{
	/**
	 * The name of the components for which mouse clicked events will be directed to
	 * the method.
	 */
